...
const
    MimeDecodeVersion  = 124;
    CopyRight : String = ' TMimeDecode (c) 1998-2002 Francois Piette V1.24 ';
...
type
    ...
    TInlineDecodeLine = procedure (Sender: TObject; Line: PChar; Len : Integer) of object;
